  ...
  const baseInsights: Insight[] = [
    {
      ...
      description:
        "Based on current progress with assisted walking, Emma is likely to walk independently within the next 2-3 weeks.",
      childId: "child-1",
    ...
    },
    {
      ...
      description:
        "Lucas shows a 40% increase in vocabulary usage this month. Peak learning occurs between 10-11 AM.",
      childId: "child-2",
    ...
    },
    {
      ...
      description:
        "Consider scheduling more playdates. Social interaction memories have decreased by 60% this week.",
      childId: null,
    ...
    },
    {
      ...
      description:
        "Emma's problem-solving skills are 23% above typical milestones for her age group.",
      childId: "child-1",
    ...
    },
    {
      ...
      description:
        "Lucas is showing signs of two-word combinations. Expect short sentences within 4-6 weeks.",
      childId: "child-2",
    ...
    },
    {
      ...
      description:
        "Both children show improved sleep patterns when bedtime routine starts at 7:30 PM.",
      childId: null,
    ...
    },
    {
      ...
      description:
        "No physical activity memories recorded for Emma in 5 days. Consider capturing outdoor play moments.",
      childId: "child-1",
    ...
    },
    {
      ...
      description:
        "Lucas shows 30% fewer tantrums compared to last month, indicating improved emotional development.",
      childId: "child-2",
...
export default function InsightsPage() {
  ...
  const filteredInsights = useMemo(() => {
    ...
    if (activeChildId) {
      filtered = filtered.filter(
        (i) => i.childId === activeChildId || i.childId === null,
      );
    }
  ...
  const handleRefresh = async () => {
    ...
    const newInsight: Insight = {
      ...
      description:
        "Recent memories show increased creative play activities in the afternoon.",
  ...
  const stats = useMemo(() => {
    ...
    const highConfidence = filteredInsights.filter(
      (i) => (i.confidence || 0) > 0.8,
    ).length;
    const critical = filteredInsights.filter(
    ...
    <div className="min-h-screen p-4 space-y-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Predictions, patterns, and recommendations from AI analysis
        </p>
      </div>
              ...
              {filteredInsights.map((insight) => (
                <div key={insight.id} className="relative">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    ...
                    {insight.relatedMemories !== undefined &&
                      insight.relatedMemories > 0 && (
                        <Badge
                          variant="outline"
                          className="bg-white/5 border-white/10 text-xs"
                        >

...
import { validateRequestBody, memorySchema, MemoryInput } from '@/lib/validation'
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (processingStatus) {
      query = query.eq('processing_status', processingStatus as Database['public']['Enums']['processing_status_enum'])
    }
    ...
    return NextResponse.json({
      ...
      limit,
      offset,
      hasMore: memories ? memories.length === limit : false
    })

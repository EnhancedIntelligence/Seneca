...
export function requireEnvironment(env: 'development' | 'staging' | 'production') {
  if (process.env.NODE_ENV !== env) {
    throw new Error(`This operation requires NODE_ENV=${env}, but got ${process.env.NODE_ENV}`)
  }
}

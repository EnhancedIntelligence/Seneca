...
export const mockInsights = [
  {
    ...
    description:
      "Emma shows consistent progress in gross motor skills. Consider documenting balance activities.",
    childId: "child-1",
  ...
  },
  {
    ...
    description:
      "Lucas has increased vocabulary by 40% this month. Peak learning: 10-11 AM.",
    childId: "child-2",
    timestamp: daysAgo(1),
  },
  {
    ...
    description:
      "It's been 5 days since last social interaction memory. Consider capturing playtime moments.",
    childId: null,
    timestamp: daysAgo(2),
  },
];

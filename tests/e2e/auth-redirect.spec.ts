...
test.describe('Authentication Redirects', () => {
  test('should redirect unauthenticated users to login from dashboard routes', async ({ page }) => {
  ...
  test('should redirect to login from any dashboard sub-route', async ({ page }) => {
  ...
  test('should allow access to auth routes without authentication', async ({ page }) => {
    await page.context().clearCookies();
  ...
  test('magic link callback should exchange code for session', async ({ page }) => {
